  ...
  const getEventsList = async () => {
    ...
    try {
        ...
        const response = await axios.get(
            'https://alphao2.herokuapp.com/api/alpha/reservas/reservalist',
    ...
    const getReserve = async(item) => {
        ...
        try {
            ...
            console.log(`https://alphao2.herokuapp.com/api/alpha/reservas/reserva-create/${item}`)
            const response = await axios.post(
                `https://alphao2.herokuapp.com/api/alpha/reservas/reserva-create/${item}`,
                { },
                { headers: { 'accept': 'application/json' , 'authorization': await token } }
            );
