  ...
  export const powers = [
    {
      id:1,
      title: "MUSICAL",
      resume: "Orfeo inauguró míticamente en Occidente el “poder musical”.  Mediante la música era capaz de influir en la naturaleza.",
      body:"Orfeo inauguró míticamente en Occidente el \“poder musical\”. Mediante la música era capaz de influir en la naturaleza.  Bajo el influjo de su música, podía hacer florecer los árboles en invierno y calmar a los animales salvajes.Actualmente la investigación científica en Músicoterapia y en Psicología de la Música confirma la eficacia de este poder.  Como lo aseveran Tomatis, Campbell, Menuhim e Imberty, la música no sólo se vincula con las áreas perceptivas de la sensibilidad y de la innovación, sino que posee poderes de transformación sobre plantas, animales y, en especial, sobre los seres humanos.En Biodanza, la música es rigurosamente seleccionada, con criterios semánticos, para estimular y despertar emociones sentimentales, eróticas, eufóricas, nostálgicas, las cuales, al ser danzadas, se transforman en vivencias.",
      image:
    ...
    },
    {
      ...
      resume: "Biodanza posee un repertorio de más de 250 ejercicios y danzas que activan los movimientos humanos en forma armónica.",
      body:"Biodanza posee un repertorio de más de 250 ejercicios y danzas que activan los movimientos humanos en forma armónica e integradora;  que estimulan las vivencias de vitalidad, sexualidad, creatividad, afectividad y trascendencia.En Biodanza la música se transforma en movimiento corporal, “se encarna” hasta que el danzante entra en vivencia.  De la combinación música-movimiento-vivencia se desencadenan cambios sutiles en el organismo que elevan la calidad de vida, para alcanzar la plenitud y el goce de vivir.",
      image:
    ...
    },
    {
      ...
      resume: "Biodanza es una poética del encuentro humano” (Rolando Toro).",
      body: "\“Biodanza es una poética del encuentro humano\” (Rolando Toro). La conexión o contacto con las personas es esencial en todo acto de rehabilitación o curación, no existe crecimiento en solitario. La conexión verbal es insuficiente.  Es necesaria la danza en pareja ó colectiva y el compromiso corporal dentro de un contexto sensible, sutil y en feed-back. La caricia, es contacto y conexión porque trabajan en vivencias significativas de amor y comunión.",
      image:
    ...
    },
    {
      id:5,
      title: "TRANCE",
      resume:"Es un estado alterado de conciencia que implica la disminución del ego y regresión a lo primordial.",
      body: "Es un estado alterado de conciencia que implica la disminución del ego y regresión a lo primordial, a lo originario, en cierto modo a etapas perinatales, a estados iniciales de la existencia.Sus efectos son de renovación biológica, porque reedita las condiciones biológicas del comienzo del desarrollo y las primeras necesidades de protección, nutrición y contacto.Los ejercicios de trance permiten la reparentalización, es decir “nacer de nuevo” dentro de un contexto de amor y cuidado.",
      image:
    ...
    },
    {
      ...
      resume:"Es un estado de percepción ampliada que restablece el vínculo primordial con el universo.",
      body: "Es un estado de percepción ampliada que restablece el vínculo primordial con el universo, mediante músicas, danzas y ceremonias de encuentro, provocando un sentimiento intenso de unidad ontocosmológica y alegría trascendente, de plenitud, y frecuentemente de éxtasis. a través de ejercicios de afectividad y trascendencia.",
      image:
    ...
    },
    {
      id:7,
      title: "GRUPO",
      resume:"Es una matriz de renacimiento que integra a nivel afectivo porque es un campo de interacción intenso.",
      body: "Es una matriz de renacimiento que integra a nivel afectivo porque es un campo de interacción intenso, en donde la inducción recíproca de vivencias entre los participantes del grupo, tienen el poder de cambiar profundamente actitudes y formas de relacionamiento humano.",
      image:
