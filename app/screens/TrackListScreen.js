...
const { loadSounds,playSound } = useContext(MusicContext);
...
const renderSingleMusic = ({item, index}) => {
  ...
  console.log("CANCION SELECCIONADA",item)
  return (
    <>
      <Pressable onPress={() => {
      ...
      <Pressable onPress={() => setisPlayerModalVisible(true)}>
        <View style={[styles.widgetContainerControl]}>
          <View style={{flexDirection: 'row'}}>
            <Image
              resizeMode="cover"
              source={{uri: selectedMusic.imagen}}
              ...
              <View>
                  ...
                  <View style={styles.progressBar}>
                      ...
                      <Slider
                          ...
                          onValueChange={value => {
                            setCurrentPosition(secsToTimestamp(value * selectedMusic.duracion ));
                            console.log(value * selectedMusic.duracion)
                          ...
                          maximumValue={1}
                      />
                      <Text style={styles.mainText}>{secsToTimestamp(selectedMusic.duracion)}</Text>
                  </View>
              </View>
